...
#
# project_test_knight.tcl: Tcl script for re-creating project 'test_knight'
#
# Generated by Vivado on Tue Jan 16 18:55:17 JST 2018
...
#
# 1. This project restoration tcl script (project_test_knight.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/windows/f/work/zynq/test_hdl_lib/test_knight/srcs/knight_test.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/windows/f/work/zynq/test_hdl_lib/bsh_hdl_lib/divider/divider.v"
#    "/windows/f/work/zynq/test_hdl_lib/bsh_hdl_lib/knight/knight_pwm.v"
#    "/windows/f/work/zynq/test_hdl_lib/bsh_hdl_lib/pwm/pwm.v"
#    "/windows/f/work/zynq/test_hdl_lib/bsh_hdl_lib/knight/knight.v"
#    "/windows/f/work/zynq/test_hdl_lib/bsh_hdl_lib/ZedBoard/zed_ledports.xdc"
#    "/windows/f/work/zynq/test_hdl_lib/bsh_hdl_lib/ZedBoard/zed_swports.xdc"
#
#*****************************************************************************************
...
set script_file "project_test_knight.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/test_knight"]"
...
set files [list \
 ...
 "[file normalize "$origin_dir/bsh_hdl_lib/knight/knight_pwm.v"]"\
...
set_property -name "top" -value "knight_test" -objects $obj
...
if { [get_files knight_pwm.v] == "" } {
  import_files -quiet -fileset sources_1 $proj_dir/../bsh_hdl_lib/knight/knight_pwm.v
}
if { [get_files pwm.v] == "" } {
  import_files -quiet -fileset sources_1 $proj_dir/../bsh_hdl_lib/pwm/pwm.v
}
if { [get_files knight_test.v] == "" } {
  import_files -quiet -fileset sources_1 $proj_dir/srcs/knight_test.v
}
...
# knight_test
  ...
  # Create instance: knight_test_0, and set properties
  set block_name knight_test
  set block_cell_name knight_test_0
  if { [catch {set knight_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $knight_test_0 eq "" } {
  ...
  connect_bd_net -net SW_1 [get_bd_ports SW] [get_bd_pins knight_test_0/speed]
  connect_bd_net -net knight_test_0_led [get_bd_ports LED] [get_bd_pins knight_test_0/led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins knight_test_0/clk_in] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
