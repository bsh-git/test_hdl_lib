...
#
# project_test_divider.tcl: Tcl script for re-creating project 'test_divider'
#
# Generated by Vivado on Thu Jan 11 12:13:05 +0900 2018
...
#
# 1. This project restoration tcl script (project_test_divider.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "F:/work/zynq/test_hdl_lib/test_divider/srcs/divider_test.v"
#
...
set script_file "project_test_divider.tcl"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "divider_test" -objects $obj
...
# divider_test
  ...
  # Create instance: divider_test_0, and set properties
  set block_name divider_test
  set block_cell_name divider_test_0
  if { [catch {set divider_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $divider_test_0 eq "" } {
  ...
  connect_bd_net -net SW_1 [get_bd_ports SW] [get_bd_pins divider_test_0/sw]
  connect_bd_net -net divider_test_0_led [get_bd_ports LED] [get_bd_pins divider_test_0/led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins divider_test_0/clk_in] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
