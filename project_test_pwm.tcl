...
#
# Generated by Vivado on Tue Jan 09 17:22:41 +0900 2018
...
set script_file "project_test_pwm.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/test_pwm"]"
...
set files [list \
 ...
 "[file normalize "$proj_dir/srcs/pwm_test.v"]"\
]
...
if { [get_files divier.v] == "" } {
  import_files -quiet -fileset sources_1 $proj_dir/../bsh_hdl_lib/divider/divier.v
}
if { [get_files pwm_test.v] == "" } {
  import_files -quiet -fileset sources_1 $proj_dir/srcs/pwm_test.v
}
...
# pwm_test
  ...
  set block_name pwm_test
  set block_cell_name pwm_test_0
  if { [catch {set pwm_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pwm_test_0 eq "" } {
  ...
  connect_bd_net -net pwm_test_0_led [get_bd_ports LED] [get_bd_pins pwm_test_0/led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins pwm_test_0/clk_in] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
